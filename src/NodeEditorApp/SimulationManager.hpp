...
public:
	...
	void RunSimulator(size_t scene_session_id, model::NodeSceneModel& scene_model, std::shared_ptr<BlockClassesManager> classes_manager, Application& app);
	void StopSimulator();
	...
	size_t GetLastSimulationSessionId() const { return m_last_simulation_scene_session_id; }
...
private:
	...
	size_t m_last_simulation_scene_session_id;
