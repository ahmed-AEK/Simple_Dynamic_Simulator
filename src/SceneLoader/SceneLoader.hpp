...
{
public:
	virtual void ModifyBlock(node::model::BlockModel& block) = 0;
};
...
public:
	...
	virtual std::optional<node::model::NodeSceneModel> Load(SubSceneId id, BlockModifier* block_modifier = nullptr) = 0;
